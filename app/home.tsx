...
export default function HomeScreen() {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <LinearGradient colors={["#6883bc", "#3b4d61"]} style={styles.header}>
...
// import { Alert, Animated, AppState, Dimensions, Modal, StyleSheet, TouchableOpacity } from "react-native";
...
//     const loadMedications =useCallback(async () => {
//         try{
//             const [allMedications, todaysDoeses] = await Promise.all([
//                 getMedication(), 
//                 getTodaysDoses(),]);
//             setDoseHistory(todaysDoeses);
//             setMedications(allMedications);
...
//                 if(
//                     durationsDays === -1 || (today >= startDate && today <= new Date(startDate.getTime() + durationsDays *  24 * 60 * 60 * 1000))
//                 ){
//                     return true;
//                 }
//                 return false;
...
//             const completed = todaysDoeses.filter((dose) => dose.taken).length;
//             setCompletedDoses(completed);
//         }catch(error){
//             console.error("Error loading Medications:", error);
//         }
...
//     }catch(error){
//         console.error("Error recording does:", error);
//         Alert.alert("Error", "Failed to record dose . Please try again.");
//     }
// };
// const isDoseTaken =(medicationId: string) => {
//     return doseHistory.some((dose) => dose.medicationId === medicationId && dose.taken);
// };
// const progress = todaysMedication.length > 0 ? completedDoses / (todaysMedication.length * 2) : 0 ;
// return(
...
//                         <Text style={styles.greeting}>Daily Progress</Text>
//                     </View>
//                     <TouchableOpacity style={styles.notficationButton} onPress={() => setShowNotification(true)}>
//                         <Ionicons  name="notifications-outline" size={24} color="white"/>
//                         {
//                             <View style={styles.notificationBadge}>
...
//                <CircularProgress
//                progress={progress}
//                totalDoses={todaysMedication.length * 2 }
...
//             <View style={styles.sectionHeader}>
//                 <Text style={styles.sectionTitle}>Today's Schedule</Text>
//                 <Link rel="stylesheet" href="/calendar" asChild>
//                     <TouchableOpacity>
//                         <Text style={styles.seeAllButton}>See All</Text>
//                     </TouchableOpacity>
//                 </Link>
...
//                     <View style={styles.emptyState}>
//                          <Fontisto name="doctor" size={48} color="#ccc" />
//                         <Text style={styles.emptyStateText}>No Medication Schedule for today</Text>
...
//             }
//         </View>
//         <Modal visible={false} transparent={true} animationType="slide" onRequestClose={() => setShowNotification(false)}>
//             <View style={styles.modalOverlay}>
//                 <View style={styles.modalContent}>
