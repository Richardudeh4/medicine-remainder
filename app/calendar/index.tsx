    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          >
            <Ionicons name="chevron-back" size={28} color="#3b4d61" />
          </TouchableOpacity>
...
// import { Ionicons } from '@expo/vector-icons';
// import { useRouter } from 'expo-router';
// import { DoseHistory, getDoseHistory, getMedication, Medication, recordDose } from '@/utils/storage';
// import { useFocusEffect } from '@react-navigation/native';
...
//     return medications.map((medication) => {
//       const taken = dayDoses.some((dose) => dose.medicationId === medication.id && dose.taken);
//       return(
//         <View>
//           <View/>
//           <View>
//           <Text style={styles.medicationName}>medication</Text>
//           <Text style={styles.medicationMessage}>dosage</Text>
...
//             }
//             >
//               <Ionicons name="chevron-back" size={24} color="#6883bc"/>
//             </TouchableOpacity>
//             <Text style={styles.monthText}>
//               {selectedDate.toLocaleString('default', {
//                 month: "long",
...
//               )
//             }>
//               <Ionicons name='chevron-forward' size={28} color="#6883bc"/>
//             </TouchableOpacity>
//           </View>
//           <View style={styles.weekdayHeader}>
//             {WEEKDAYS.map((day) => (
