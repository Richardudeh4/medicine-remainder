...
const AddMedicationScreen = () => {
                        ...
                        setForm({...form, frequency: freq.label})
                            ...
                            styles.optionIcon, 
                             selectedFrequency === freq.label && styles.selectedOptionIcon,
                                ...
                                <Ionicons
                                 name={freq.icon} size={24} color={selectedFrequency === freq.label ? "white" : "#666"}/>
    ...
    const validateForm = () => {
        ...
        if(!form.frequency){
            newErrors.name = "Frequency is required";
        }
        if(!form.duration){
            newErrors.name = "Duration is required";
        }
    ...
    const handleSave = async () => {
        try{
            ...
            const colors = ["#872642", "#DBC1AD", "#7F056E", "#0C4A60", "#354649"];
            ...
            Alert.alert("Error", "Failed to save medication. Please try again.", [{text:"OK"}],
                {cancelable: false}
            );
        } finally{
  ...
  return (
    <View style={styles.container}>
     <LinearGradient colors={["#6883bc", "#3b4d61"]} 
     start={{ x:0, y:0 }} 
     end={{x:1, y:1}}
            ...
            <View style={styles.content}>
                <View style={styles.header}>
                    <TouchableOpacity style={styles.backButton}>
                        <Ionicons name="chevron-back" size={28} color="#6883bc "/>
                    </TouchableOpacity>
                       ...
                       {errors.duration && (
                          ...
                          <TouchableOpacity style={styles.dateButton} onPress={() => setShowDatePicker(true)}>
                            <View style={styles.dateIconContainer}>
                                <Ionicons name="calendar" size={20} color={"#6883bc"}/>
                            </View>
                          ...
                          {
                            form.frequency && form.frequency !== "As nedded" && (
                                <View style={styles.timesContainer}>
                                    <Text style={styles.timesTitle}>Medication Times</Text>
                                {
                                    form.times.map((time, index) =>(
                                        <TouchableOpacity 
                                        style={styles.timeButtton}
                                        key={index}
                                        onPress={() => {setShowTimePicker(true);}}
                                        >
                                            <View style={styles.timeIconContainer}>
                                            <Ionicons name="time-outline" size={20} color={"#6883bc"}/>
                                            </View>
                        ...
                        <View style={styles.switchRow}>
                            <View style={styles.switchLabelContainer}>
                                <View style={styles.iconContainer}>
                                    <Ionicons name="notifications" color={'#6883bc'} size={24}/>
                                </View>
                                    <View style={{}}>
                                        <Text style={styles.switchLabel}>Reminders</Text>
                                        <Text style={styles.switchSubLabel}>Get notified when it's time to take your medications</Text>
                                    </View>
                            </View>  
                            <Switch
                            value={form.reminderEnabled}
                            trackColor={{ false: "#ddd", true: "#6883bc" }}
                            thumbColor={'white'}
